...
type TabType = "overview" | "orders" | "products" | "customers" | "analytics" | "settings";
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex">
      ...
      <motion.aside
        ...
        className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-card border-r transform lg:translate-x-0 transition-transform duration-200 ease-in-out`}
      >
